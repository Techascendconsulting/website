  ...
  return (
    <main className="pt-28 bg-[#0B0F14] min-h-screen">
      ...
      <section ref={hero.ref as any} className="pb-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div style={{opacity: hero.visible ? 1 : 0, transform: hero.visible ? 'none' : 'translateY(10px)', transition: 'all 400ms ease-out'}}>
            <h1 className="text-4xl md:text-5xl font-bold text-white">Build your consulting career</h1>
            <p className="mt-4 text-slate-300 text-lg">Join as a consultant or project-ready analyst. Deliver real outcomes with senior support and clear progression.</p>
            <div className="mt-6">
          ...
          <div>
            <img src="https://images.pexels.com/photos/3184360/pexels-photo-3184360.jpeg" alt="Team collaboration" className="w-full h-[360px] object-cover rounded-2xl border border-white/10 shadow-2xl" loading="lazy" />
          </div>
        </div>
      </section>
      ...
      <section ref={blocks.ref as any} className="py-10">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <img src="https://images.pexels.com/photos/3184454/pexels-photo-3184454.jpeg" alt="Mentorship" className="w-full h-[300px] object-cover rounded-2xl border border-white/10 shadow-xl" loading="lazy"
          ...
          <div style={{opacity: blocks.visible ? 1 : 0, transform: blocks.visible ? 'none' : 'translateY(8px)', transition: 'all 380ms ease-out 60ms'}}>
            <h2 className="text-3xl font-bold text-white">Mentored by senior consultants</h2>
            <p className="mt-2 text-slate-300">Learn on real work with the safety net of leadership support—evidence of capability from day one.</p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto px-6 mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div style={{opacity: blocks.visible ? 1 : 0, transform: blocks.visible ? 'none' : 'translateY(8px)', transition: 'all 380ms ease-out'}}>
            <h2 className="text-3xl font-bold text-white">Progression with purpose</h2>
            <p className="mt-2 text-slate-300">Structured pathways into BA, PO, PM, and delivery leadership—aligned to the outcomes you deliver.</p>
          </div>
          <img src="https://images.pexels.com/photos/3184306/pexels-photo-3184306.jpeg" alt="Progression" className="w-full h-[300px] object-cover rounded-2xl border border-white/10 shadow-xl" loading="lazy"
